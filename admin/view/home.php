                                    ...
                                    <div class="new-member-list">
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="./view/assets/imgs/people/avatar4.jpg" alt="" class="avatar">
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="./view/assets/imgs/people/avatar2.jpg" alt="" class="avatar">
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex align-items-center">
                                                <img src="./view/assets/imgs/people/avatar3.jpg" alt="" class="avatar">
                                                <div>
