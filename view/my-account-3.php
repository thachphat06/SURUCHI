                ...
                <div class="my__account--section__inner border-radius-10 d-flex">
                    <div class="account__left--sidebar">
                        ...
                        <ul class="account__menu">
                            <li class="account__menu--list"><a href="index.php?pg=my-account">Địa chỉ</a></li>
                            <li class="account__menu--list active"><a href="index.php?pg=my-account-3">Thông tin mua hàng</a></li>
