                                    ...
                                    <div class="product__tab--content">
                                        ...
                                        <!-- <div class="product__tab--content__step">
                                            ...
                                            <ul>
                                                ...
                                                <li class="product__tab--content__list">
                                                    <svg class="product__tab--content__list--icon" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"></path></svg>
                                                    Bạn muốn mua áo cho nam hay nữ?                                                </li>
                                                <li class="product__tab--content__list">
                                                    <svg class="product__tab--content__list--icon" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"></path></svg>
                                                    Bạn ưa thích chất liệu nào cho áo của bạn?                                                </li>
                                                <li class="product__tab--content__list">
                                                    <svg class="product__tab--content__list--icon" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"></path></svg>
                                                    Bạn muốn xem áo mới nhất hay áo bán chạy nhất?                                                </li>
                                                <li class="product__tab--content__list">
                                                    <svg class="product__tab--content__list--icon" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"></path></svg>
                                    ...
                                    <div class="product__reviews">
                                        <div class="product__reviews--header">
                                            ...
                                            <div class="reviews__ratting d-flex align-items-center">
                                                ...
                                                <span class="reviews__summary--caption">Dựa trên 2 đánh giá</span>
                                            </div>
                                        ...
                                        <div class="reviews__comment--area">
                                            <div class="reviews__comment--list d-flex">
                                                <div class="reviews__comment--thumb">
                                                    <img src="./view/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                                                </div>
                                                <div class="reviews__comment--content">
                                                    <div class="reviews__comment--top d-flex justify-content-between">
                                                        <div class="reviews__comment--top__left">
                                                            <h3 class="reviews__comment--content__title h4">Minh Thư</h3>
                                                        ...
                                                        <span class="reviews__comment--content__date">Ngày 18 tháng 2 năm 2022</span>
                                                    </div>
                                                    <p class="reviews__comment--content__desc">Sản phẩm khá tốt, chất liệu ổn, đã mua ở đây 5 lần và vẫn rất hài lòng!!</p>
                                                </div>
                                            </div>
