<?php
    ...
    foreach ($dsdm as $dm) {
        extract($dm);
        $link='index.php?pg=shop&iddm='.$iddm;
        $html_dm.='<li class="widget__categories--menu__list"><a href="'.$link.'">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                    <img class="widget__categories--menu__img" src="./view/assets/img/product/small-product1.png" alt="categories-img">
                    <span class="widget__categories--menu__text">'.$name_dm.'</span>
                    </label></a>
                </li>';
    }
    $html_dssp='';
    foreach ($dssp as $sp) {
        extract($sp);
        if($bestseller==1){
            $bestseller='<span class="product__badge--items sale">Sale</span>';
        }else{
            $bestseller='';
        }
        ...
        <div class="product__items ">
            ...
            <div class="product__items--content">
                ...
                <div class="product__items--price">
                    <span class="current__price">'.$price.'VND</span>
                                ...
                                <div class="product__grid--inner">
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="./view/assets/img/product/small-product1.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="./view/assets/img/product/small-product2.png" alt="product-img">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="./view/assets/img/product/small-product3.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="./view/assets/img/product/small-product4.png" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                    ...
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                            <a class="product__items--link" href="product-details.html">
                                                <img class="product__items--img product__primary--img" src="./view/assets/img/product/small-product5.png" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="./view/assets/img/product/small-product6.png" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="product__items--grid__content">
                                        ...
                                        <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                                ...
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            ...
                                                            <img class="product__items--img product__secondary--img" src="./view/assets/img/product/product12.png" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">Sale</span>
                                                        </div>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="./view/assets/img/product/product13.png" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="./view/assets/img/product/product14.png" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">Sale</span>
                                                        </div>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="./view/assets/img/product/product2.png" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="./view/assets/img/product/product1.png" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">Sale</span>
                                                        </div>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="./view/assets/img/product/product6.png" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="./view/assets/img/product/product5.png" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">Sale</span>
                                                        </div>
                                                ...
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            ...
                                                            <img class="product__items--img product__secondary--img" src="./view/assets/img/product/product7.png" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">Sale</span>
                                                        </div>
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="./view/assets/img/product/product10.png" alt="product-img">
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="./view/assets/img/product/product15.png" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="./view/assets/img/product/product14.png" alt="product-img">
                                                        </a>
                                                        <div class="product__badge">
                                                            <span class="product__badge--items sale">Sale</span>
                            ...
                            <div class="pagination__area bg__gray--color">
                                <nav class="pagination justify-content-center">
                                    <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                        ...
                                        <li class="pagination__list"><a href="index.php?pg=shop" class="pagination__item link">2</a></li>
                                        <li class="pagination__list"><a href="index.php?pg=shop" class="pagination__item link">3</a></li>
                                        <li class="pagination__list"><a href="index.php?pg=shop" class="pagination__item link">4</a></li>
                                        <li class="pagination__list">
                                            <a href="index.php?pg=shop" class="pagination__item--arrow  link ">
