                        ...
                        <div class="account__login">
                            <form action="index.php?pg=reset-pass&id=<?= $iduser ?>" method="post">
                                ...
                                <div class="account__login--inner">
                                    ...
                                    <!-- <button class="account__login--btn primary__btn" type="submit" value="submit">Gửi mail</button> -->
                                    <div class="form-group">
                                        <input type="submit" value="Submit" class="account__login--btn primary__btn" name="guipwd">
                                    </div>
                                </div>
                            </from>
                        </div>
