                ...
                <div class="row">
                        ...
                        <div class="blog__details--wrapper">
                            ...
                            <div class="blog__tags--social__media d-flex align-items-center justify-content-between">
                                <div class="blog__tags--media d-flex align-items-center">
                                    <label class="blog__tags--media__title">Thẻ liên quan :</label>
                                    <ul class="d-flex">
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="blog-details.html">Phổ Biến</a></li>
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="blog-details.html">Việc Kinh Doanh</a></li>
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="blog-details.html">Giảm Bớt</a></li>
                                        <li class="blog__tags--media__list"><a class="blog__tags--media__link" href="blog-details.html">Dịch Vụ</a></li>
                                    </ul>
                                </div>
                            ...
                            <div class="comment__box">
                                <div class="reviews__comment--area2 mb-50">
                                    <h2 class="reviews__comment--reply__title mb-25">Bình luận gần đây</h2>
                                    <div class="reviews__comment--inner">
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img class="display-block" src="./view/assets/img/other/comment-thumb1.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content ">
                                                <div class="comment__content--topbar d-flex justify-content-between">
                                                    <div class="comment__content--topbar__left">
                                                        <h4 class="reviews__comment--content__title2">Minh Dương</h4>
                                                        <span class="reviews__comment--content__date2">Ngày 18 tháng 2 năm 2022</span>
                                                    </div>
                                                    <button class="comment__reply--btn primary__btn" type="submit">Hồi đáp</button>
                                                </div>
                                                <p class="reviews__comment--content__desc">Mình thích cách họ kết hợp áo phông layering, tạo nên sự ấn tượng và phối hợp linh hoạt với nhiều phong cách khác nhau. Sẽ ghé cửa hàng ngay!</p>
                                            </div>
                                        </div>
                                        <div class="reviews__comment--list margin__left d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img class="display-block" src="./view/assets/img/other/comment-thumb2.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="comment__content--topbar d-flex justify-content-between">
                                                    <div class="comment__content--topbar__left">
                                                        <h4 class="reviews__comment--content__title2">Hữu Nghĩa</h4>
                                                        <span class="reviews__comment--content__date2">Ngày 18 tháng 2 năm 2022</span>
                                                    </div>
                                                    <button class="comment__reply--btn primary__btn" type="submit">Hồi đáp</button>
                                                </div>
                                                <p class="reviews__comment--content__desc">Mình đang tìm kiếm một chiếc áo với họa tiết animal print, và bài viết này đúng là nguồn cảm hứng tuyệt vời. Cám ơn!</p>
                                            </div>
                                        </div>
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img class="display-block" src="./view/assets/img/other/comment-thumb3.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="comment__content--topbar d-flex justify-content-between">
                                                    <div class="comment__content--topbar__left">
                                                        <h4 class="reviews__comment--content__title2">Nguyễn Huynh</h4>
                                                        <span class="reviews__comment--content__date2">Ngày 18 tháng 2 năm 2022</span>
                                                    </div>
                                                    <button class="comment__reply--btn primary__btn" type="submit">Hồi đáp</button>
                                                </div>
                                                <p class="reviews__comment--content__desc">Bài viết giúp mình cập nhật những xu hướng thời trang mới mà không cần phải đọc quá nhiều. Rất hữu ích cho những người bận rộn như mình!</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="reviews__comment--reply__area">
                                    <form action="#">
                                        <h2 class="reviews__comment--reply__title mb-20">Để lại một bình luận</h2>
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 mb-20">
                                                <label>
                                                    <input class="reviews__comment--reply__input" placeholder="Tên của bạn...." type="text">
                                                </label>
                                            </div>  
                                            <div class="col-lg-4 col-md-6 mb-20">
                                                <label>
                                                    <input class="reviews__comment--reply__input" placeholder="Email của bạn...." type="email">
                                                </label>
                                            </div> 
                                            <div class="col-lg-4 col-md-6 mb-20">
                                                <label>
                                                    <input class="reviews__comment--reply__input" placeholder="Trang web của bạn...." type="text">
                                                </label>
                                            </div> 
                                            <div class="col-12 mb-15">
                                                <textarea class="reviews__comment--reply__textarea" placeholder="Bình luận của bạn...." ></textarea>
                                            </div> 
                                             
                                        </div>
                                        <button class="reviews__comment--btn primary__btn text-white" data-hover="Submit" type="submit">Gửi</button>
                                    </form>   
                                </div> 
                            </div> 
                        </div>
                    ...
                    <!-- <div class="col-xxl-3 col-xl-4 col-lg-4">
                        <div class="blog__sidebar--widget left widget__area">
                            ...
                            <div class="single__widget widget__bg">
                               <h2 class="widget__title h3">Đăng bài viết</h2>
                                <div class="product__grid--inner">
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="blog-details.html">Áo form rộng</a></h3>
                                            <span class="meta__deta">Ngày 03 tháng 2 năm 2023</span>
                                        </div>
                                    </div>
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        <div class="product__items--grid__thumbnail position__relative">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="blog-details.html">Váy dài</a></h3>
                                            <span class="meta__deta">Ngày 03 tháng 2 năm 2023</span>
                                        </div>
                                    </div>
                                    <div class="product__items product__items--grid d-flex align-items-center">
                                        ...
                                        <div class="product__items--grid__content">
                                            <h3 class="product__items--content__title h4"><a href="blog-details.html">Túi sách</a></h3>
                                            <span class="meta__deta">Ngày 03 tháng 2 năm 2023</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="single__widget widget__bg">
                                <h2 class="widget__title h3">Nhãn hiệu</h2>
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Áo khoác</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Phụ nữ</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Quá khổ</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Bông </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Vai </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Mùa đông</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Phụ kiện</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="blog-details.html">Váy </a></li>
                                </ul>
                            </div>
                        </div>
                    </div> -->
