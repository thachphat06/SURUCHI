                    ...
                    <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-sm-u-2 row-cols-1 mb--n30">
                        ...
                        <div class="col mb-30">
                            <div class="blog__items">
                                ...
                                <div class="blog__content">
                                    <span class="blog__content--meta">Ngày 03 tháng 2 năm 2023</span>
                                    <h3 class="blog__content--title"><a href="blog-details.html">Ưu đãi hấp dẫn: Mua áo và nhận ngay những quà tặng thú vị!</a></h3>
                                    <a class="blog__content--btn primary__btn" href="blog-details.html">Đọc thêm </a>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-30">
                            <div class="blog__items">
                                ...
                                <div class="blog__content">
                                    <span class="blog__content--meta">Ngày 03 tháng 2 năm 2023</span>
                                    <h3 class="blog__content--title"><a href="blog-details.html">Tinh tế và Sang trọng: Áo công sở cho phụ nữ hiện đại</a></h3>
                                    <a class="blog__content--btn primary__btn" href="blog-details.html">Đọc thêm </a>
                                </div>
                            </div>
                        </div>
                        <div class="col mb-30">
                            <div class="blog__items">
                                ...
                                <div class="blog__content">
                                    <span class="blog__content--meta">Ngày 03 tháng 2 năm 2023</span>
                                    <h3 class="blog__content--title"><a href="blog-details.html">Chinh phục mọi sở thích: Bộ sưu tập áo đa dạng từ casual đến sporty</a></h3>
                                    <a class="blog__content--btn primary__btn" href="blog-details.html">Đọc thêm </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <nav class="pagination justify-content-center">
                            <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                <li class="pagination__list">
                                    <a href="index.php?pg=blog" class="pagination__item--arrow  link ">
                                ...
                                <li class="pagination__list"><a href="index.php?pg=blog" class="pagination__item link">2</a></li>
                                <li class="pagination__list"><a href="index.php?pg=blog" class="pagination__item link">3</a></li>
                                <li class="pagination__list"><a href="index.php?pg=blog" class="pagination__item link">4</a></li>
                                <li class="pagination__list">
                                    <a href="index.php?pg=blog" class="pagination__item--arrow  link ">
