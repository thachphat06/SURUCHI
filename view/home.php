<?php
        ...
        <div class="product__items ">
            ...
            <div class="product__items--content">
                ...
                <div class="product__items--price">
                    ...
                    <span class="old__price">'.$old_price.'VND</span>
                </div>
    ...
    foreach ($dssp_hot as $sp) {
        extract($sp);
        if($hot==1){
            $hot='<span class="product__badge--items sale">Sale</span>';
        }else{
            $hot='';
        }
    ...
    foreach ($dssp_new as $sp) {
        extract($sp);
        if($new==1){
            $new='<span class="product__badge--items sale">Sale</span>';
        }else{
            $new='';
        }
