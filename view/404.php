        ...
        <div class="row row-cols-1">
            <div class="col">
                <div class="breadcrumb__content text-center">
                    <h1 class="breadcrumb__content--title text-white mb-25">Lỗi 404</h1>
                    <ul class="breadcrumb__content--menu d-flex justify-content-center">
                        <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.php">Trang chủ</a></li>
                        <li class="breadcrumb__content--menu__items"><span class="text-white">Lỗi 404</span></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row row-cols-1">
            <div class="col">
                <div class="error__content text-center">
                    <img class="error__content--img mb-50" src="../public/assets_client/img/other/404-thumb.png" alt="error-img">
                    <h2 class="error__content--title">Ối ! Chúng tôi không tìm thấy trang này</h2>
                    <p class="error__content--desc">Xin chào, thật sự là một nỗi đau khi phải theo dõi. Một chút tâm trí nên được giả định.</p>
                    <a class="error__content--btn primary__btn" href="home.php">Trở về trang chủ</a>
                </div>
            </div>
        </div>
    </div>
